...
const RESOURCE_ACQUIRED = "resourceAcquired";
const RESOURCE_RELEASED = "resourceReleased";
...
class Pool extends EventEmitter {
  ...
  acquire(priority) {
    ...
    return resourceRequest.promise.then(resource => {
  ...
  release(resource) {
    ...
    this._dispense();
    return this._Promise.resolve().then(res => {
