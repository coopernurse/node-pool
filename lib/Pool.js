...
class Pool extends EventEmitter {
  ...
  destroyAllNow () {
    ...
    const destroyOps = this._availableObjects.map(this._destroy, this)
    return Promise.all(destroyOps)
  }
